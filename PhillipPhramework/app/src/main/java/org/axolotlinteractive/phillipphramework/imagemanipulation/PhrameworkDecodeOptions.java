package org.axolotlinteractive.phillipphramework.imagemanipulation;
...
class PhrameworkDecodeOptions {
	 ...
	 * @throws ByteException if the bounds have not already been calculated or either the width and height are less then zero
	 */
